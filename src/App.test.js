...
let mockFunction, booksArray, book;
beforeEach(() => {
...
test("renders search component", () => {
  render(
    <BrowserRouter>
      <Search booksArray={booksArray} updateShelf={mockFunction} />
    </BrowserRouter>
  );
...
test("renders shelfs component", () => {
  render(
    <BrowserRouter>
      <Shelfs booksArray={booksArray} updateShelf={mockFunction} />
    </BrowserRouter>
  );
